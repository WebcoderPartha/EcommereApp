    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Update new product <a href="{{ route('admin.product.all') }}" class="btn btn-sm btn-success pull-right">All Product</a></h6>
                        ...
                        <div class="row mg-b-0">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('product_name') is-invalid @enderror" value="{{ $product->product_name }}" id="product_name" type="text" name="product_name" placeholder="Enter product name">
                                    @error('product_name')
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input id="product_code" value="{{ $product->product_code }}" class="form-control @error('product_code') is-invalid @enderror" type="text" name="product_code" placeholder="Enter product code">
                                    @error('product_code')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ $product->product_quantity }}" class="form-control @error('product_quantity') is-invalid @enderror" type="text" name="product_quantity" id="product_quantity" placeholder="Enter product quantity">
                                    @error('product_code')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <select id="subcategory_id" name="subcategory_id" class="form-control select2" data-placeholder="Choose Sub-Category">
                                        ...
                                        @foreach($subcategories as $subcat)
                                            <option value="{{ $subcat->id }}" @if($product->subcategory_id == $subcat->id) selected @endif>{{ $subcat->subcategory_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div><!-- col-4 -->
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('product_details') is-invalid @enderror" name="product_details" id="summernote">{!! $product->product_details !!}</textarea>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <img src="{{ asset($product->image_two) }}" id="two" alt="">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <img src="{{ asset($product->image_three) }}" id="three" alt="">
                                </div>
                            </div><!-- col-4 -->
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="video_link" class="form-control-label">Video Link: <span class="tx-danger">*</span></label>
                                    <input class="form-control @error('video_link') is-invalid @enderror" value="{{$product->video_link}}" type="text" name="video_link" id="video_link" placeholder="Enter video link">
                                    @error('video_link')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
