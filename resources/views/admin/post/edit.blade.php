    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Edit post <a href="{{ route('admin.blog.list') }}" class="btn btn-sm btn-success pull-right">All Post</a></h6>
                        ...
                        <div class="row mg-b-0">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('post_title_en') is-invalid @enderror" id="post_title_en" type="text" name="post_title_en" value="{{ $post->post_title_en }}" placeholder="Enter post title in english">
                                    @error('post_title_en')
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('post_title_in') is-invalid @enderror" id="post_title_in" type="text" name="post_title_in" value="{{ $post->post_title_in }}" placeholder="Enter post title in hindi">
                                    @error('post_title_in')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="postcategory_id" id="postcategory_id" class="form-control select2" data-placeholder="Select Category">
                                        ...
                                        @foreach($categories as $category)
                                            <option
                                                value="{{ $category->id }}"
                                                @if($post->postcategory_id == $category->id)
                                                    selected
                                                @endif
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('details_en') is-invalid @enderror" name="details_en" id="summernote">{!! $post->details_en !!}</textarea>
                                    @error('details_en')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="details_in" class="form-control-label">Post Details In Hindi: <span class="tx-danger">*</span></label>
                                    <textarea class="form-control @error('details_in') is-invalid @enderror" name="details_in" id="details_hindi">{!! $post->details_in !!}</textarea>
                                    @error('details_in')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
