...
@section('admin_content')
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="{{ route('pending.order') }}">Report</a>
            <span class="breadcrumb-item active">Search By Year</span>
        </nav>

        <div class="sl-pagebody">

            <div class="card pd-20 pd-sm-10">
                <h6 class="text-info">Total Amount: <b>{{ $total_amount }} BDT</b></h6>
