                                ...
                                @foreach($featured as $recent)
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            ...
                                            @else
                                                @php
                                                    $ammout = $recent->selling_prize - $recent->discount_price;
                                                    $discount = $ammout / $recent->selling_prize * 100;
                                                @endphp
                            ...
                            <div class="product_panel panel">
                                <div class="featured_slider slider">
                                    ...
                                    <div class="featured_slider_item">
                                        <div class="border_active"></div>
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('frontent/images/featured_2.png') }}" alt=""></div>
                                            <div class="product_content">
